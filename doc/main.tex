...
\begin{figure}[h]\label{fig:emissions}
  ...
  \label{fig:emissions}
\end{figure}
Analyzing \Cref{fig:emisissions}, two things can be concluded: First, our hypothesis, that the plant-based and animal-based food products have two different underlying distributions can be confirmed. Second, the distribution over total emissions of plant-based products clearly does not follow a Gaussian distribution. 
...
\begin{table} \label{tbl:results}
  ...
  \begin{tabular}{lllll}
    ...
    \cmidrule(r){2-5}
    Feature     & Test-Statistic   & $\alpha$  & Test-Statistic  & $\alpha$\\
    \midrule
    Total Emissions & Input terminal  & $\sim$100     \\
    GHG     & Output terminal & $\sim$10      \\
